...
В 6 лабораторной работе был использован ["Churn Modelling"](https://www.kaggle.com/datasets/shubh0799/churn-modelling/data) датасет. Набор данных представляет собой подробную информацию о клиентах компании.

Содержание
В столбце указана предполагаемая зарплата, возраст, пол и т. д. Целью является предоставление всей информации о сотруднике.

![image](https://github.com/sat4h/AIT/assets/146749026/d3e961c0-62fd-4132-9c51-c9d2cdaad114)
